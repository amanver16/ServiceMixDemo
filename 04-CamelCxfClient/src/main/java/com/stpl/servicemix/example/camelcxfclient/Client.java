...
package com.stpl.servicemix.example.camelcxfclient;
...
public class Client {
	private static final String PERSON_SERVICE_URL = "http://localhost:8989/rest/associateService/associate/readAllAssociate/";
	...
	public void getPerson(int id) throws Exception {
		...
		HttpURLConnection connection = connect(PERSON_SERVICE_URL);
